...
const AdminRequestsPage: React.FC = () => {
    const { bookings, approveChangeRequest, rejectChangeRequest, refreshData } = useBooking();
    ...
    return (
        <DashboardLayout portal="admin">
             <div className="flex justify-between items-center mb-8">
                <h1 className="text-3xl font-bold text-primary">Customer Booking Requests</h1>
